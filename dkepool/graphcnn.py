...
class GraphCNN(nn.Module):
    def __init__(self, num_layers, num_mlp_layers, input_dim, hidden_dim, output_dim, rep_dim, final_dropout, learn_eps,
        ...
        self.dke_pool = nn.Linear(self.gauss_dim, rep_dim, bias=False)
    ...
    def forward(self, batch_graph):
        ...
        # DKEPool Module
        # while self.dke_type == 1, performing robust DKEPool module
        ...
        dke_representation = self.dke_pool(dke_representation)
